...
public class Main {
    ...
    public static void runProgram(Translator translator) {
        while (true) {
            ...
            String q = "quit";
            // DONE CheckStyle: The String "quit" appears 3 times in the file.
            // DONE Checkstyle: String literal expressions should be on the left side of an equals comparison
            if (country.equals(q)) {
                break;
            }
